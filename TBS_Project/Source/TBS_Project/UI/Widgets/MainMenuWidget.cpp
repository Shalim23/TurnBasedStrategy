...
void UMainMenuWidget::FindGame()
{
    ...
    BaseGameEvent* findGameEvent = 
        eventDispatcherInstance.GetEvent(GameplayEventType::FindGame);

    BaseGameEvent* leaveFromMainMenuEvent = 
        eventDispatcherInstance.GetEvent(GameplayEventType::LeaveFromMainMenu);
